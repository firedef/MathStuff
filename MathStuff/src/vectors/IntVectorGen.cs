...
#region operators
    ...
    public static implicit operator int3(int2 v) => new(v.x, v.y, 0);
...
#region operators
    ...
    public static implicit operator int4(int2 v) => new(v.x, v.y, 0, 0);
    ...
    public static implicit operator int4(int3 v) => new(v.x, v.y, v.z, 0);
