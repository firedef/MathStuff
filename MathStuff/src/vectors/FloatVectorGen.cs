...
#region operators
	...
	public static implicit operator float3(float2 v) => new(v.x, v.y);
...
#region operators
	...
	public static implicit operator float4(float2 v) => new(v.x, v.y);
	...
	public static implicit operator float4(float3 v) => new(v.x, v.y, v.z);
